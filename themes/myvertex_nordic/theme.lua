...
theme.icon_dir                                  = os.getenv("HOME") .. "/.config/awesome/themes/myvertex_one/icons"
theme.wallpaper                                 = os.getenv("HOME") .. "/.config/awesome/themes/myvertex_one/wall.jpg"
theme.font                                      = "Roboto Bold 7.5"
theme.taglist_font                              = "Roboto Bold 7"
...
theme.panelbg3                                  = "#2E3440" -- "#00000055"
theme.menubar_bg_normal                         = "#2E3440" -- "#00000055"
theme.menubar_fg_normal                         = "#A0A0A0FF"
theme.bg_systray                                = "#2E3440" -- "#00000000"
...
-- awful.util.tagnames = { "1","2","3","4","5","6","7","emacs","web"}
 ...
 local names = { "1","2","3","4","5","6","7","emacs","web"}
...
--    awful.tag(awful.util.tagnames, s, awful.layout.layouts[1])
    ...
    s.mypromptbox.bg = "#2E3440" -- #00000000"
 ...
 --   s.mytasklist = awful.widget.tasklist(s, awful.widget.tasklist.filter.focused, awful.util.tasklist_buttons, {  bg = "#242424" })
    s.mytasklist = awful.widget.tasklist(s, awful.widget.tasklist.filter.currenttags, awful.util.tasklist_buttons, { bg_normal = "#2E3440", bg_focus = barcolor3 })

    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, height = dpi(15), bg = theme.panelbg3 })
