...
theme.icon_dir                                  = os.getenv("HOME") .. "/.config/awesome/themes/myvertex_embers/icons"
theme.wallpaper                                 = os.getenv("HOME") .. "/.config/awesome/themes/myvertex_embers/wall.jpg"
...
theme.panelbg3                                  = "#16130f" -- "#00000055"
theme.menubar_bg_normal                         = "#16130f" -- "#00000055"
theme.menubar_fg_normal                         = "#A0A0A0FF"
theme.bg_systray                                = "#16130f" -- "#00000000"
...
--]]
    ...
    s.mypromptbox.bg = "#16130f" -- #00000000"
 ...
 --   s.mytasklist = awful.widget.tasklist(s, awful.widget.tasklist.filter.focused, awful.util.tasklist_buttons, {  bg = "#242424" })
    s.mytasklist = awful.widget.tasklist(s, awful.widget.tasklist.filter.currenttags, awful.util.tasklist_buttons, { bg_normal = "#16130f", bg_focus = barcolor3 })
