...
-- theme.font          = theme.gtk.font_family .. ' ' .. 8
-- theme.tasklist_font_focus = theme.gtk.font_family .. ' Bold ' .. 9

theme.font                                      = "Roboto 8"
theme.taglist_font                              = "Roboto 7.5"
-- theme.taglist_font                              = theme.gtk.bold_font
theme.tasklist_font_focus                       = "Roboto 8"
